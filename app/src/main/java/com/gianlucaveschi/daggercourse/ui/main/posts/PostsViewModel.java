...
import com.gianlucaveschi.daggercourse.util.Resource;
...
public class PostsViewModel extends ViewModel {
    ...
    //Resource is a wrapper class for Posts
    ...
    public LiveData<Resource<List<Post>>> observePosts(){
        if(posts == null) {
            ...
            final LiveData<Resource<List<Post>>> source = LiveDataReactiveStreams.fromPublisher(
                    /*In this case we break the MVVM architecture on purpose by accessing
                     the session manager directly for the sake of simplicity.*/
